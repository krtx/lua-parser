...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa6a059663ba5dfad601d7e2da5a9882) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         {OCamlbuildCommon.plugin_tags = None; extra = ["-use-menhir"]};
     test = [];
     doc = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lua_parser"; "Lua_syntax"; "Lua_lexer"];
                      lib_pack = false;
     ...
     oasis_digest = Some "\019\196Xf\150\2012\140\191I\239\232\021\250@\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
